...
> = {
  ...
  knowany: () => import('./knowany/index.vue'),
  knowany_views_datasource: () => import('./knowany/views/datasource/index.vue'),
  knowany_views_knowledgebase: () => import('./knowany/views/knowledgebase/index.vue'),
  knowledge_create: () => import('./knowledge/create/index.vue'),
  knowledge_details: () => import('./knowledge/details/index.vue'),
  ...
  'source-management': () => import('./source-management/index.vue'),
  'ybp-list': () => import('./ybp-list/index.vue')
};
