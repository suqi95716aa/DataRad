...
import RobotDialog from './robot-dialog/index.vue';

export { SettingDrawer, GlobalHeader, GlobalTab, GlobalSider, GlobalContent, GlobalFooter, GlobalLogo, RobotDialog };
